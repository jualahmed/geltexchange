											...
											<?php if($results) foreach ($results as $key => $v):?>
														...
														?>
															<tr>
																...
																<td>
																	<?php if(isset($v->external_icon)): ?>
																		<img src="<?php echo base_url().$v->external_icon ?>" alt="" width="25px;">
																	<?php else: ?><img src="<?php echo base_url().'assets/images/avatar.jpg' ?>" alt="" width="25px;">
																	<?php endif ?>
																	<span>  <?php if(isset($v->name)) echo htmlspecialchars($v->name); ?></span>
																</td>
																<td>
																	<?php if(isset($v->currency_name)){
																		echo htmlspecialchars($v->amount_send.' '.$v->currency_name, ENT_QUOTES, 'UTF-8');
																	}
																	?>
																</td>
																<td>
																...
																<td><?php if(isset($gateway_r->currency_name)) echo htmlspecialchars($v->amount_receive.' '.$gateway_r->currency_name, ENT_QUOTES, 'UTF-8'); ?></td>
