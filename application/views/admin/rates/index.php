            ...
            <table class="table table-striped table-hover table-bordered">
              ...
              <?php foreach ($results as $key => $value): ?>
                ...
                <tr>
                  ...
                  <td><img src="<?php echo base_url().$value->external_icon ?>" alt="" width="20px;"><?php echo $value->name ?></td>
                  <td><img src="<?php echo base_url().$toinfo->external_icon ?>" alt="" width="20px;"><?php echo $toinfo->name ?></td>
                  <td><?php echo $value->rate_from ?> <span><?php echo " ".$value->currency_name ?></span> = <?php echo $value->rate_to ?><?php echo " ".$toinfo->currency_name ?></td>
                  <td>
