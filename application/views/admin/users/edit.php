                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                            ...
                                            <div class="col-sm-2">
                                               <div class="checkbox">
                                                    <label>
                                                        <input type="checkbox" name="final_verified" value="1" <?php echo $user->final_verified ? "checked" : ''  ?>>
                                                        is verified
                                                    </label>
                                               </div>
                                            </div>
                                             <div class="col-sm-2">
                                               <div class="checkbox">
                                                    <label>
                                                        <input type="checkbox" name="document_verified" value="1" <?php echo $user->document_verified ? "checked" : ''  ?>>
                                             ...
                                             <div class="col-sm-2">
                                               <div class="checkbox">
                                                    <label>
                                                        <input type="checkbox" name="phone_verified" value="1" <?php echo $user->phone_verified ? "checked" : ''  ?>>
                                                        is phone verified
                                                    </label>
                                               </div>
                                            </div>
