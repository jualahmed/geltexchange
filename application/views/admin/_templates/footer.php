...
?>
            ...
            <footer class="main-footer">
                ...
                <strong><?php echo lang('footer_copyright'); ?> &copy; 2014-<?php echo date('Y'); ?> <a href="https://www.facebook.com/md.jual.ah" target="_blank">Almsaeed Studio</a> &amp; <a href="https://www.facebook.com/md.jual.ah" target="_blank">domProjects</a>.</strong> <?php echo lang('footer_all_rights_reserved'); ?>.
            </footer>
        </div>
