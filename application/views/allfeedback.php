<section id="feedback" class="pb-2 mt-4 p-0">
	<div class="container">
		<div class="section box-shadow min-h-screen p-3 my-3">
			<h3 class="text-center py-3"><strong>Customers Feedback</strong></h3>
			<div class="row">
				 <?php if(count($results)) { ?>
							<?php foreach ($results as $key => $var): ?>
							<div class="col-md-4">
								<div class="ad-info box-shadow" style="border: 1px solid;text-align: center;">
