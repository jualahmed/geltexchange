			...
			<center> 
				<div class="top-header pt-1">
					<marquee behavior="scroll" direction="left" onmouseover="this.stop();" onmouseout="this.start();" id="MARQUEE1" class="scrolling">  
						<b class="text-info pb-0">
							<span class="pr-1">Notice: </span><span class="text-white"><?php echo $d->notice ?></span>
						</b>
					</marquee>  
				</div>
			</center>
		</div>
		<div class="text-center py-1" style="background: #005455;color: #fff;">
			<img width="23px" class="p-0" src="<?php echo base_url()."assets/temp/uploads/clock.png"; ?>" alt=""> Office Time: <?php echo $d->start_time ?> - <?php echo $d->end_time ?>
			<img width="20px" class="pl-1" src="<?php echo base_url()."assets/temp/uploads/operator.png"; ?>" alt=""> <span class="pr-1">Operator:</span>
			<?php if($d->is_online){ ?>
